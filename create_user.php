...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  users(name,email,mobile,category,comapny,registration) value('$name','$email','$mobile','$category','$comapny','$registration')");
    if ($query) {
   ...
   <?php include_once('includes/header.php');?>
    ...
    echo $msg;
  									...
  									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="email" id="email" name="email" class="form-control" placeholder="Email Address" required="true"></div>
                                    </div>
  									<!-- end -->
  									...
  									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="mobile" name="mobile" class="form-control" placeholder="Mobile Number" required="true"></div>
                                    </div>
  									<!-- end -->
